...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/29 00:36:52 by oredoine          #+#    #+#             */
/*   Updated: 2022/11/17 23:43:03 by oredoine         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
extern int		ft_isalpha(int a);
extern int		ft_isascii( int a);
extern int		ft_isdigit(int a);
extern int		ft_isprint(int a);
...
extern size_t	ft_strlcpy(char *dst, char *src, size_t dstsize);
